...
<li class="dropdown user user-menu">
	...
	<a href="#" class="dropdown-toggle" data-toggle="dropdown">
		...
		<?php 
			echo (!empty($this->request->getSession()->read('Auth.User.profile.full_name')))?
					$this->request->getSession()->read('Auth.User.profile.full_name')
					: 'Minha conta';
		?>
		</span>
	</a>
	<ul class="dropdown-menu">
		...
		<li class="user-body">
			<div class="row">
				<div class="text-center">
					<strong><?php echo $this->request->getSession()->read('Auth.User.email'); ?></strong><br>
					<small>
						<?= 'Cadastrado em '.$this->request->getSession()->read('Auth.User.created') ?>
					</small>
				</div>
			</div>
		</li>
		...
		<li class="user-footer">
			<div class="pull-left">
				<?php
					//if($this->request->getSession()->read('Auth.User.profile')){
