		...
		<div class="collapse navbar-collapse pull-left" id="navbar-collapse">
			...
			<?php
				...
				if(!empty($menu)){
					...
					echo '<li>'.$this->Html->link('<i class="fa fa-home"></i>', ['controller'=>'Dashboards', 'action'=>'index', 'plugin'=>false, '_full'=>true], ['escape'=>false]).'</li>';

					foreach($this->request->getSession()->read('Auth.User.menu') as $k=>$menu){
